...
public class PosDetailFragment extends BaseFragment implements OnClickListener {
	...
	public void onClick(View v) {
		if (v == address) {
			...
			oks.setText("我在#138中国美容人才网#看到" + jobInfo.getCompanyName() + "招聘" + jobInfo.getHireName() + "(" + jobInfo.getNumber() + "-"
					+ jobInfo.getPay() + ")" + "http://m.138job.com/Job/Hire-" + jobInfo.getHireId());
