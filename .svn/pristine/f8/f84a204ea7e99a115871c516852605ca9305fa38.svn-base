...
public class PersonalSeemActivity extends BaseActivity {
	 ...
	 * 获取简历被看邀请
	 */
	public class GetSeemTask extends AsyncTask<String, Integer, List<JobInfo>> {
		...
		protected List<JobInfo> doInBackground(String... arg0) {
			try {
				List<JobInfo> list = JobManageService.getResumeReaded(pageUtil, PersonInfoSave.memberInfo.getMemberId());
				return list;
